...
class Timer:
    ...
    def measure_median(self, func, samples=3, **kwargs):
        """
        Applies self.measure() samples times and return the median of measures.
        :param func: python function
        :param samples: iteration quantity
        :param kwargs:
        :return: the median of measures effectuated by self.measure()
        """
        values = []
